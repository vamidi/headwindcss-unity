...
namespace HeadWindCSS.Editor.Domains.Resources
{	
	internal static class ResourceHelper
	{
		const string ResourceRoot = "Packages/com.vamidicreations.headwindcss/Editor/Resources";
		const string TemplateRoot = "Packages/com.vamidicreations.headwindcss/Editor/UI/Templates";
		const string StyleRoot = "Packages/com.vamidicreations.headwindcss/Editor/UI/Styles";
